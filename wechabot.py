...
class Nude(object):
    # CLASS MEMBERS:
    # class: skin
    # variable: image(PIL.Image.open 's return type), skin_map, 
    # local variable: bands, new_img, 
...
class Face(object):
    ...
    def detect_face(self, face_encoding):
        ...
        for record in record_list:
            ...
            distance.append(face_recognition.face_distance(encoding,face_encoding))
